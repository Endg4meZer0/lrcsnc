...
func TestGetLyrics(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			ldata: structs.LyricsData{
				Lyrics: []structs.Lyric{
					{Timing: 0, Text: "Filed in place, matching in pace, cowards with batons hiding their face"},
					{Timing: 0, Text: "Dispersing counter action, the dividing distraction"},
					{Timing: 0, Text: "I watched them get away without a trace"},
					{Timing: 0, Text: ""},
					{Timing: 0, Text: "Led astray and left behind, your ideals made you blind"},
					{Timing: 0, Text: ""},
					{Timing: 0, Text: "Stand behind, hold the line, backstab, in the name of worthless pride"},
					{Timing: 0, Text: "As they're worshiped by those they lobotomized"},
					{Timing: 0, Text: ""},
					{Timing: 0, Text: "Insipid and hollow, you're no leader, you just follow"},
					{Timing: 0, Text: "The damage you've done, this pain you've caused being swept below"},
					{Timing: 0, Text: "There's no indifference"},
					{Timing: 0, Text: "I can't ignore this"},
					{Timing: 0, Text: "Protect and serve?"},
					{Timing: 0, Text: "You're dismissed"},
					{Timing: 0, Text: ""},
					{Timing: 0, Text: "Black bruises blooming, red and blue glooming"},
					{Timing: 0, Text: "The sirens flood as freedom's drained away"},
					{Timing: 0, Text: "No redemption as my faith begins to fade"},
				},
