...
func (c *client) changeOutput() error {
	newDest, err := os.OpenFile(global.Config.C.Client.Destination, os.O_RDWR|os.O_CREATE|os.O_APPEND, 0o644)
	if err != nil {
		...
		_, err := os.OpenFile(c.tempFile, os.O_RDWR|os.O_CREATE|os.O_APPEND, 0o644)
		if err != nil {
